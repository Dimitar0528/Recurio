        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 ">
          ...
          <div className="md:col-span-4 bg-card border border-border p-8 rounded-2xl text-center items-center flex flex-col justify-center md:text-left md:items-start">
            ...
            <p className="text-sm max-w-md text-muted-foreground leading-relaxed">
              Intentionality starts with data entry. By manually adding subs,
              you confront the cost before the charge happens.
            </p>
          </div>
          ...
          <div className="md:col-span-8 bg-gray-900 dark:bg-gray-300 text-background p-8 rounded-2xl flex items-center justify-between overflow-hidden relative">
            <div className="relative z-10 max-w-lg mx-auto md:mx-0">
              ...
              <p className="text-sm text-background/80 leading-relaxed">
                ...
                within your browser's secure environment—never on our servers.
                We don't just protect your data; we ensure we never have custody
