import { CalendarIcon, ChartPieSliceIcon, CreditCardIcon, ShieldCheckIcon } from "@phosphor-icons/react";
     ...
     <div className="max-w-7xl mx-auto">
       <div className="flex flex-col items-center md:flex-row md:items-end justify-between mb-16 gap-6 ">
         <div className="max-w-xl">
           ...
           <p className="text-4xl font-bold tracking-tight text-foreground mx-auto">
             Clarity is a feature, <br />
             not an accident.
           </p>
         </div>
         <p className="text-muted-foreground max-w-xs text-md leading-relaxed">
           Recurio was built on the principle that if you can't see the total
           impact, you can't make an informed choice.
         </p>
       </div>
       ...
       <div className="grid grid-cols-1 md:grid-cols-12 gap-4 ">
         <div className="md:col-span-8 bg-card border border-border p-8 rounded-2xl flex flex-col justify-between min-h-[400px] ">
           <div className="max-w-md mx-auto md:mx-0">
             <div className="w-12 h-12 rounded-xl bg-primary/10 text-primary flex items-center justify-center mb-6">
               <ChartPieSliceIcon size={28} weight="duotone" />
             </div>
             <h3 className="text-2xl font-bold mb-3">Cost Normalization</h3>
             <p className="text-muted-foreground leading-relaxed">
               We struggle to compare a 12 €/mo app with a 120 €/year service.
               Recurio translates every commitment into a single, normalized
               "Burn Rate," exposing the true weight of your digital footprint.
             </p>
           </div>
         ...
         <div className="md:col-span-4 bg-secondary/30 border border-border p-8 rounded-2xl flex flex-col text-center items-center justify-center md:text-left md:items-stretch">
           ...
           <h3 className="text-xl font-bold mb-3">Time Awareness</h3>
           <p className="text-sm text-muted-foreground leading-relaxed mb-6 items-center justify-center max-w-md">
             Our detection engine identifies upcoming charges within 7, 14, and
             30-day windows. No "surprise" renewals.
           </p>
           <div className="mt-auto space-y-2 ">
             ...
             <p className="text-[10px] font-mono text-muted-foreground uppercase">
               Renewal proximity: 7 days
             </p>
           </div>
         </div>

         <div className="md:col-span-4 bg-card border border-border p-8 rounded-2xl text-center items-center flex flex-col justify-center md:text-left md:items-start">
           <div className="w-10 h-10 rounded-lg bg-accent text-accent-foreground flex items-center justify-center mb-6">
             <CreditCardIcon size={22} color="oklch(0.59 0.20 277)" />
           </div>
           <h3 className="text-xl font-bold mb-3">Manual Entry</h3>
           <p className="text-sm max-w-md text-muted-foreground leading-relaxed">
             Intentionality starts with data entry. By manually adding subs, you
             confront the cost before the charge happens.
           </p>
         </div>
         ...
         <div className="md:col-span-8 bg-gray-900 dark:bg-gray-300 text-background p-8 rounded-2xl flex items-center justify-between overflow-hidden relative">
           <div className="relative z-10 max-w-lg mx-auto md:mx-0">
             ...
             <p className="text-sm text-background/80 leading-relaxed">
               Your financial footprint is processed and stored exclusively
               within your browser's secure environment—never on our servers. We
               don't just protect your data; we ensure we never have custody of
